...
describe('ApiClient', () => {
  ...
  describe('getClients', () => {
    it('should call GET /api/clients', async () => {
      const mockResponse = { data: { clients: [{ id: 1, name: 'Test Client' }] } };
      mockAxiosInstance.get.mockResolvedValueOnce(mockResponse);
  ...
  describe('createClient', () => {
    it('should call POST /api/clients with client data', async () => {
      const clientData = { name: 'New Client', description: 'Test description' };
  ...
  describe('updateClient', () => {
    it('should call PUT /api/clients/:id with updated data', async () => {
  ...
  describe('createWorkEntry', () => {
    it('should call POST /api/work-entries with entry data', async () => {
      const entryData = { clientId: 1, hours: 8, description: 'Work done', date: '2024-01-01' };
  ...
  describe('updateWorkEntry', () => {
    it('should call PUT /api/work-entries/:id with updated data', async () => {
