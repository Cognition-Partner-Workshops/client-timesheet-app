...
describe('ApiClient', () => {
  ...
  describe('login', () => {
    it('should call POST /api/auth/login with email', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/auth/login', { email: 'test@example.com' })
  ...
  describe('getClient', () => {
    it('should call GET /api/clients/:id', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/clients/1')
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('createClient', () => {
    it('should call POST /api/clients with client data', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/clients', clientData)
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('updateClient', () => {
    it('should call PUT /api/clients/:id with client data', async () => {
      ...
      expect(mockClient.put).toHaveBeenCalledWith('/api/clients/1', clientData)
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('deleteClient', () => {
    it('should call DELETE /api/clients/:id', async () => {
      ...
      expect(mockClient.delete).toHaveBeenCalledWith('/api/clients/1')
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('getWorkEntries', () => {
    it('should call GET /api/work-entries without params', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/work-entries', { params: {} })
      expect(result).toEqual(mockResponse.data)
    })
    ...
    it('should call GET /api/work-entries with clientId param', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/work-entries', { params: { clientId: 1 } })
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('getWorkEntry', () => {
    it('should call GET /api/work-entries/:id', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/work-entries/1')
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('createWorkEntry', () => {
    it('should call POST /api/work-entries with entry data', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/api/work-entries', entryData)
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('updateWorkEntry', () => {
    it('should call PUT /api/work-entries/:id with entry data', async () => {
      ...
      expect(mockClient.put).toHaveBeenCalledWith('/api/work-entries/1', entryData)
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('deleteWorkEntry', () => {
    it('should call DELETE /api/work-entries/:id', async () => {
      ...
      expect(mockClient.delete).toHaveBeenCalledWith('/api/work-entries/1')
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('getClientReport', () => {
    it('should call GET /api/reports/client/:clientId', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/reports/client/1')
      expect(result).toEqual(mockResponse.data)
    })
  })
  ...
  describe('exportClientReportCsv', () => {
    it('should call GET /api/reports/export/csv/:clientId with blob response type', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/reports/export/csv/1', { responseType: 'blob' })
  ...
  describe('exportClientReportPdf', () => {
    it('should call GET /api/reports/export/pdf/:clientId with blob response type', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/api/reports/export/pdf/1', { responseType: 'blob' })
      expect(result).toEqual(mockBlob)
    })
  })
