...
describe('ApiClient', () => {
  ...
  describe('createWorkEntry', () => {
    it('should call POST /api/work-entries with entry data', async () => {
      const { apiClient } = await import('../../api/client');
      const entryData = { clientId: 1, hours: 8, description: 'Work done', date: '2024-01-15' };
  ...
  describe('exportClientReportCsv', () => {
    it('should call GET /api/reports/export/csv/:clientId with blob responseType', async () => {
      const { apiClient } = await import('../../api/client');
  ...
  describe('exportClientReportPdf', () => {
    it('should call GET /api/reports/export/pdf/:clientId with blob responseType', async () => {
      const { apiClient } = await import('../../api/client');
