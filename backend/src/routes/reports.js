...
router.get('/client/:clientId', (req, res) => {
  ...
  // Verify client exists (global clients - any authenticated user can access)
  db.get(
    ...
    (err, client) => {
      ...
      // Get work entries for this client (filtered by user)
      db.all(
...
router.get('/export/csv/:clientId', (req, res) => {
  ...
  db.get(
    ...
    (err, client) => {
      ...
      // Get work entries (filtered by user)
      db.all(
