/**
 * @fileoverview Report generation routes for the Time Tracker API.
 * 
 * This module provides endpoints for generating and exporting client reports.
 * Reports include aggregated work entries and total hours for a specific client.
 ...
 * and calculated totals. Only returns data for clients owned by the
 * authenticated user.
 * 
 * @route GET /api/reports/client/:clientId
 * @param {number} req.params.clientId - Client ID
 ...
 * 
 * Exports a client report as a downloadable CSV file. The file contains
 * all work entries with date, hours, description, and creation timestamp.
 * 
 ...
 * @returns {Object} 400 - Invalid client ID format
 * @returns {Object} 404 - Client not found
 * @returns {Object} 500 - Database or file generation error
 */
 ...
 * 
 * Exports a client report as a downloadable PDF file. The PDF includes
 * a formatted report with client name, total hours, entry count, and
 * a table of all work entries.
 * 
 ...
 * @returns {Object} 400 - Invalid client ID format
 * @returns {Object} 404 - Client not found
 * @returns {Object} 500 - Database or PDF generation error
 */
