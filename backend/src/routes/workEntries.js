 ...
 * 
 * This module provides RESTful endpoints for managing work entries (time records).
 * All routes require authentication via the x-user-email header. Work entries are
 * scoped to individual users and must be associated with a valid client.
 * 
 ...
 * Results are sorted by date (descending) and creation time.
 * 
 ...
 * 
 * Validates that the specified client exists and belongs to the authenticated user
 ...
 * @param {string} [req.body.description] - Work description (optional)
 * @param {string} req.body.date - Work date in ISO format (required)
 ...
 * 
 * If clientId is being updated, validates that the new client exists and
