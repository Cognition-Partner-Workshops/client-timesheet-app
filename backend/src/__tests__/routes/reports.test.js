...
describe('Report Routes', () => {
  ...
  describe('GET /api/reports/client/:clientId', () => {
    ...
    test('should get work entries for client (shared across all users)', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, { id: 1, name: 'Test Client' });
      });
  ...
  describe('Shared Data Access', () => {
    test('should return data for any authenticated user (shared across all users)', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        expect(params).toEqual([1]);
        callback(null, { id: 1, name: 'Test Client' });
      });
  ...
  describe('CSV Export Success Path', () => {
    ...
    test('should verify CSV export calls correct database queries (shared across all users)', async () => {
      const mockClient = { id: 1, name: 'Test Client' };
  ...
  describe('PDF Export Success Path', () => {
    ...
    test('should verify PDF export calls correct database queries (shared across all users)', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, { id: 1, name: 'Test Client' });
      });
