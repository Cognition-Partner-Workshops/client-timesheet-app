...
describe('Auth Routes', () => {
  ...
  describe('POST /api/auth/register', () => {
    ...
    test('should return 400 for invalid email in register', async () => {
      const response = await request(app)
        .post('/api/auth/register')
    ...
    test('should return 400 for missing password in register', async () => {
      const response = await request(app)
        .post('/api/auth/register')
    ...
    test('should handle database error when checking user in register', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
    ...
    test('should handle database error when creating user in register', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
